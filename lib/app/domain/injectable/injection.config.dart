...
import 'package:sqflite/sqlite_api.dart' as _i17;

import '../../../auth/application/auth/auth_bloc.dart' as _i24;
import '../../../auth/application/login/login_bloc.dart' as _i18;
import '../../../auth/application/signup/signup_bloc.dart' as _i23;
import '../../../auth/domain/i_auth_facade.dart' as _i15;
import '../../../auth/infrastructure/auth_repository.dart' as _i16;
import '../../../people/application/people/people_bloc.dart' as _i21;
import '../../../people/application/person/person_bloc.dart' as _i11;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i11.PersonBloc>(
      () => _i11.PersonBloc(get<_i9.PeopleRepositoryFacade>()));
  await gh.factoryAsync<_i12.SharedPreferences>(() => injectableModule.prefs,
      preResolve: true);
  gh.factory<_i13.StorageService>(
      () => _i13.StorageService(get<_i12.SharedPreferences>()));
  gh.factory<_i14.ClientApi>(() => injectableApi.api(get<_i3.Config>()));
  gh.lazySingleton<_i15.IAuthFacade>(() =>
      _i16.AuthRepository(get<_i13.StorageService>(), get<_i17.Database>()));
  gh.factory<_i18.LoginBloc>(() => _i18.LoginBloc(get<_i15.IAuthFacade>()));
  gh.factory<_i19.MainRepositoryFacade>(() =>
      _i20.MainRepository(get<_i7.MainShowApiFacade>(), get<_i6.Database>()));
  gh.factory<_i21.PeopleBloc>(
      () => _i21.PeopleBloc(get<_i9.PeopleRepositoryFacade>()));
  gh.factory<_i22.ShowBloc>(
      () => _i22.ShowBloc(get<_i19.MainRepositoryFacade>()));
  gh.factory<_i23.SignUpBloc>(() => _i23.SignUpBloc(get<_i15.IAuthFacade>()));
  gh.factory<_i24.AuthBloc>(() => _i24.AuthBloc(get<_i15.IAuthFacade>()));
  gh.factory<_i25.EpisodesBloc>(
      () => _i25.EpisodesBloc(get<_i19.MainRepositoryFacade>()));
  return get;
}
