...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get, {String? environment, _i2.EnvironmentFilter? environmentFilter}) async {
  ...
  await gh.factoryAsync<_i6.Database>(() => injectableModule.database, preResolve: true);
  await gh.factoryAsync<_i7.SharedPreferences>(() => injectableModule.prefs, preResolve: true);
  gh.factory<_i8.ShowBloc>(() => _i8.ShowBloc());
  gh.factory<_i9.StorageService>(() => _i9.StorageService(get<_i7.SharedPreferences>()));
  gh.factory<_i10.ClientApi>(() => injectableModule.api(get<_i3.Config>()));
  gh.lazySingleton<_i11.IAuthFacade>(() => _i12.AuthRepository(get<_i9.StorageService>(), get<_i13.Database>()));
